...
/** @type {string} */
const CACHE_VERSION = '1759023166|240630242';
/** @type {string} */
const CACHE_PREFIX = 'SimonDice-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'SimonDice.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["SimonDice.html","SimonDice.js","SimonDice.offline.html","SimonDice.icon.png","SimonDice.apple-touch-icon.png","SimonDice.audio.worklet.js","SimonDice.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["SimonDice.wasm","SimonDice.pck"];
